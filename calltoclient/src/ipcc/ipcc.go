...
/* 通话结束通知 */
func ParseCallEnd(endCallMsg *[]byte) (int, string, string, string, string,error) {
	...
	return answerRet.Dir, answerRet.CallId, answerRet.Date, answerRet.FileName, answerRet.TimeStamp,nil
}
